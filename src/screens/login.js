...
class Login extends Component {
  ...
  signUp() {
    ...
    this.state.isEmailValid && this.state.isPasswordValid && this.state.isConfirmationValid &&
    Auth.signUp({
      username: email,
      password: password,
      attributes: {
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <ImageBackground
           source={{uri :'https://laborocity.com/wp-content/uploads/2018/04/new-hero-image-v4-2000x1200.jpg'}}
            ...
            <View>
              <KeyboardAvoidingView contentContainerStyle={styles.loginContainer} behavior='position'>
                <View style={styles.titleContainer}>
                  <Image source={require('../laborocity_navy.png')} style={{flex: 1, width: SCREEN_WIDTH -50, resizeMode: 'contain', alignSelf: 'center'}}>
                  </Image>
